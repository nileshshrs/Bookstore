...
import Success from "../Pages/Success"; // Import your success page component
...
const Order = () => {
  ...
  return (
    <section className="py-5">
      {!paymentSuccess ? ( // Conditionally render based on payment success state
        ...
        <Success /> // Render success page component
      )}
    </section>
  );
};
